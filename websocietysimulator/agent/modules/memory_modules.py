...
class MemoryBase:
    def __init__(self, memory_type: str, llm) -> None:
        ...
        self.scenario_memory = Chroma(embedding_function=self.embedding, persist_directory=db_path)
...
class MemoryDILU(MemoryBase):
    ...
    def addMemory(self, current_situation: str):
        ...
        memory_doc = Document(page_content=task_name, metadata={"task_name": task_name, "task_trajectory": current_situation})
...
class MemoryVoyager(MemoryBase):
    ...
    def retriveMemory(self, query_scenario: str):
        ...
        memory_trajectories = [result[0].metadata["task_trajectory"] for result in similarity_results]
...
Please fill in this part yourself
        ...
        # Create document with metadata
        doc = Document(page_content=trajectory_summary, metadata={"task_description": trajectory_summary, "task_trajectory": current_situation})
